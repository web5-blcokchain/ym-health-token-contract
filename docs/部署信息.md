...
-npx hardhat verify --network bscTestnet <HLTToken> "HealthLife Token" "HLT" <owner> <other>
+npx hardhat verify --network bscTestnet <HLTToken> "HealthLife Token" "HLT" <owner> 0xaeec208c1fdE4636570E2C6E72A256c53c774fac

# 验证 Crowdsale 合约（按部署输出中的命令为准）
npx hardhat verify --network bscTestnet <Crowdsale> <HLTToken> <USDT> <owner> <lockDuration>
```
...
- 关键地址：
  - HLTToken: `0xF7a84a11EB4FbA0c77Ac1779a11c48F1D18Bf35D`
  - Crowdsale: `0xf8E6E83A5771470D95b7E12F733f1f35DfFc5047`
